    ...
    <div class="col-md-6 col-lg-4">
      ...
      <div class="card">
        <div class="card-heading">
          ...
          <div class="card-title">Project #D</div><small>Web development</small>
        </div>
        <div class="card-body">
    ...
    <div class="col-md-6 col-lg-4">
      ...
      <div class="card">
        <div class="card-heading">
          ...
          <div class="card-title">Project #A</div><small>Web development</small>
        </div>
        <div class="card-body">
          <p><strong>Description:</strong></p>
          <div class="pl-lg mb-lg">Ut turpis urna, tristique sed adipiscing nec, luctus quis leo. Fusce nec volutpat ante.</div>
    ...
    <div class="col-md-6 col-lg-4">
      ...
      <div class="card">
        <div class="card-heading">
          ...
          <div class="card-title">Project #B</div><small>Web development</small>
        </div>
        <div class="card-body">
          <p><strong>Description:</strong></p>
          <div class="pl-lg mb-lg">Ut turpis urna, tristique sed adipiscing nec, luctus quis leo. Fusce nec volutpat ante.</div>
          <p><strong>Members:</strong></p>
          <div class="pl-lg mb-lg"><a href="" class="inline"><img src="/img/user/04.jpg" alt="project member" class="img-circle thumb32"></a><a href="" class="inline"><img src="/img/user/03.jpg" alt="project member" class="img-circle thumb32"></a><a href="" class="inline"><img src="/img/user/07.jpg" alt="project member" class="img-circle thumb32"></a><a href="" class="inline"><img src="/img/user/03.jpg" alt="project member" class="img-circle thumb32"></a></div>
          <p><strong>Activity:</strong></p>
          <div class="pl-lg">
            <ul class="list-inline m0">
              <li class="mr">
    ...
    <div class="col-md-6 col-lg-4">
      ...
      <div class="card">
        <div class="card-heading">
          ...
          <div class="card-title">Project #C</div><small>Web development</small>
        </div>
        <div class="card-body">
          <p><strong>Description:</strong></p>
          <div class="pl-lg mb-lg">Ut turpis urna, tristique sed adipiscing nec, luctus quis leo. Fusce nec volutpat ante.</div>

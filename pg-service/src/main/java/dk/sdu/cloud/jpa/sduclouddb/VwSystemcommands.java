...
public class VwSystemcommands implements Serializable {
    ...
    public String toString() {
        return "VwSystemcommands{" +
                "recid=" + recid +
                ", subsystemid=" + subsystemid +
                ", subsystemtext='" + subsystemtext + '\'' +
                ", subsystemcommandcategoryid=" + subsystemcommandcategoryid +
                ", subsystemcommandcategorytext='" + subsystemcommandcategorytext + '\'' +
                ", subsystemcommandid=" + subsystemcommandid +
                ", subsystemcommandtext='" + subsystemcommandtext + '\'' +

...
@NamedQueries({
    ...
    , @NamedQuery(name = "Projectpublicationrel.findByMarkedfordelete", query = "SELECT p FROM Projectpublicationrel p WHERE p.markedfordelete = :markedfordelete")
    , @NamedQuery(name = "Projectpublicationrel.findByModifiedTs", query = "SELECT p FROM Projectpublicationrel p WHERE p.modifiedTs = :modifiedTs")
    , @NamedQuery(name = "Projectpublicationrel.findByCreatedTs", query = "SELECT p FROM Projectpublicationrel p WHERE p.createdTs = :createdTs")})
public class Projectpublicationrel implements Serializable {
    ...
    public Projectpublicationrel(Integer id, Date modifiedTs, Date createdTs) {
        this.id = id;
    ...
    public String toString() {
        return "dk.sdu.sducloud.jpa.sduclouddb.Projectpublicationrel[ id=" + id + " ]";
    }

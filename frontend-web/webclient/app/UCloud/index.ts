...
/* Generated at: Thu Mar 11 12:03:39 CET 2021 */
...
export function retrieve(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/jobs/control" + "/retrieve", {id: request.id, includeParameters: request.includeParameters, includeUpdates: request.includeUpdates, includeApplication: request.includeApplication, includeProduct: request.includeProduct}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function retrieve(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/jobs" + "/retrieve", {id: request.id, includeParameters: request.includeParameters, includeUpdates: request.includeUpdates, includeApplication: request.includeApplication, includeProduct: request.includeProduct}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function retrieveUtilization(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/jobs" + "/retrieveUtilization", {provider: request.provider, jobId: request.jobId}),
        parameters: request,
        reloadId: Math.random(),
    };
}

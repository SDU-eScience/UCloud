...
/* Generated at: Mon Jan 18 14:17:22 CET 2021 */
 ...
 */
export type AppParameterValue = AppParameterValueNS.File | AppParameterValueNS.Bool | AppParameterValueNS.Text | AppParameterValueNS.Integer | AppParameterValueNS.FloatingPoint | AppParameterValueNS.Peer | AppParameterValueNS.License | AppParameterValueNS.Network | AppParameterValueNS.BlockStorage | AppParameterValueNS.Ingress
...
export type InvocationParameter = WordInvocationParameter | BooleanFlagParameter | VariableInvocationParameter | EnvironmentVariableParameter
...
export type ApplicationParameter = ApplicationParameterNS.InputFile | ApplicationParameterNS.InputDirectory | ApplicationParameterNS.Text | ApplicationParameterNS.Integer | ApplicationParameterNS.Bool | ApplicationParameterNS.FloatingPoint | ApplicationParameterNS.Peer | ApplicationParameterNS.Enumeration | ApplicationParameterNS.LicenseServer | ApplicationParameterNS.Ingress
...
export function findByName(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/hpc/tools" + "/" + request.appName, {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function findByName(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/hpc/apps" + "/" + request.appName, {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function findLatestByTool(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/hpc/apps" + "/byTool" + "/" + request.tool, {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function browse(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/ucloud/ucloud/licenses/maintenance" + "/browse", {consistency: request.consistency, itemsPerPage: request.itemsPerPage, itemsToSkip: request.itemsToSkip, next: request.next, tag: request.tag}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function retrieveSettings(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/ucloud/ucloud/ingresses" + "/retrieveSettings", {category: request.category, id: request.id, provider: request.provider}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function browse(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/licenses" + "/browse", {consistency: request.consistency, includeAcl: request.includeAcl, includeProduct: request.includeProduct, includeUpdates: request.includeUpdates, itemsPerPage: request.itemsPerPage, itemsToSkip: request.itemsToSkip, next: request.next, provider: request.provider, tag: request.tag}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function retrieve(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/licenses" + "/retrieve", {id: request.id, includeAcl: request.includeAcl, includeProduct: request.includeProduct, includeUpdates: request.includeUpdates}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function retrieve(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/licenses/control" + "/retrieve", {id: request.id, includeAcl: request.includeAcl, includeProduct: request.includeProduct, includeUpdates: request.includeUpdates}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function browse(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/ingresses" + "/browse", {consistency: request.consistency, domain: request.domain, includeProduct: request.includeProduct, includeUpdates: request.includeUpdates, itemsPerPage: request.itemsPerPage, itemsToSkip: request.itemsToSkip, next: request.next, provider: request.provider}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function retrieve(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/ingresses" + "/retrieve", {id: request.id, includeProduct: request.includeProduct, includeUpdates: request.includeUpdates}),
        parameters: request,
        reloadId: Math.random(),
    };
}
export function retrieveSettings(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/ingresses" + "/retrieveSettings", {category: request.category, id: request.id, provider: request.provider}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function retrieveUtilization(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/jobs" + "/retrieveUtilization", {jobId: request.jobId, provider: request.provider}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function browse(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/jobs" + "/browse", {consistency: request.consistency, filterAfter: request.filterAfter, filterApplication: request.filterApplication, filterBefore: request.filterBefore, filterLaunchedBy: request.filterLaunchedBy, filterState: request.filterState, filterTitle: request.filterTitle, includeApplication: request.includeApplication, includeParameters: request.includeParameters, includeProduct: request.includeProduct, includeUpdates: request.includeUpdates, itemsPerPage: request.itemsPerPage, itemsToSkip: request.itemsToSkip, next: request.next, sortBy: request.sortBy}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function viewMemberInProject(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects" + "/members", {projectId: request.projectId, username: request.username}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function listFavoriteProjects(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects" + "/listFavorites", {itemsPerPage: request.itemsPerPage, page: request.page, user: request.user, archived: request.archived, showAncestorPath: request.showAncestorPath}),
        parameters: request,
        reloadId: Math.random(),
    };
}
export function listProjects(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects" + "/list", {itemsPerPage: request.itemsPerPage, page: request.page, user: request.user, archived: request.archived, noFavorites: request.noFavorites, showAncestorPath: request.showAncestorPath}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function listIngoingInvites(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects" + "/invites" + "/ingoing", {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
export function listOutgoingInvites(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects" + "/invites" + "/outgoing", {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function search(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects/membership" + "/search", {query: request.query, itemsPerPage: request.itemsPerPage, page: request.page, notInGroup: request.notInGroup}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function list(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects/repositories", {itemsPerPage: request.itemsPerPage, page: request.page, user: request.user}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function listFiles(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects/repositories" + "/list-files", {itemsPerPage: request.itemsPerPage, page: request.page, user: request.user}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function listGroupsWithSummary(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects/groups" + "/summary", {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
export function listGroupMembers(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects/groups" + "/members", {group: request.group, itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function lookupByTitle(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects/groups" + "/lookup-by-title", {projectId: request.projectId, title: request.title}),
        parameters: request,
        reloadId: Math.random(),
    };
}
export function lookupProjectAndGroup(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/projects/groups" + "/lookup-project-and-group", {project: request.project, group: request.group}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function browse(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/products" + "/browse", {consistency: request.consistency, filterArea: request.filterArea, filterCategory: request.filterCategory, filterProvider: request.filterProvider, filterUsable: request.filterUsable, includeBalance: request.includeBalance, itemsPerPage: request.itemsPerPage, itemsToSkip: request.itemsToSkip, next: request.next}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function list(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/shares", {sharedByMe: request.sharedByMe, itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function listFiles(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/shares" + "/list-files", {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function listAtPath(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/files", {path: request.path, itemsPerPage: request.itemsPerPage, page: request.page, order: request.order, sortBy: request.sortBy, attributes: request.attributes, type: request.type}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function move(
    ...
    return {
        context: "",
        method: "POST",
        path: buildQueryString("/api/files" + "/move", {path: request.path, newPath: request.newPath, policy: request.policy}),
        parameters: request,
        reloadId: Math.random(),
    };
}
export function copy(
    ...
    return {
        context: "",
        method: "POST",
        path: buildQueryString("/api/files" + "/copy", {path: request.path, newPath: request.newPath, policy: request.policy}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function lookupFileInDirectory(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/files" + "/lookup", {path: request.path, itemsPerPage: request.itemsPerPage, sortBy: request.sortBy, order: request.order, attributes: request.attributes}),
        parameters: request,
        reloadId: Math.random(),
    };
}
...
export function list(
    ...
    return {
        context: "",
        method: "GET",
        path: buildQueryString("/api/files/favorite" + "/list", {itemsPerPage: request.itemsPerPage, page: request.page}),
        parameters: request,
        reloadId: Math.random(),
    };
}

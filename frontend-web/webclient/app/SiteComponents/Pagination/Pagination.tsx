...
export const Buttons = ({ totalPages, toPage, currentPage }: PaginationButtons) => (
    totalPages > 1 ?
        (<Pagination
...
export const EntriesPerPageSelector = ({ entriesPerPage, onChange, content }: EntriesPerPageSelector) => (
    <div>
        <Dropdown

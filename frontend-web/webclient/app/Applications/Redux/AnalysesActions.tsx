 ...
 */
export const fetchAnalyses = (itemsPerPage: number, page: number): Promise<ReceivePage<typeof RECEIVE_ANALYSES, Analysis> | Error<typeof SET_ANALYSES_ERROR>> =>
 ...
 */
const receiveAnalyses = (page: Page<Analysis>): ReceivePage<typeof RECEIVE_ANALYSES, Analysis> => ({
 ...
 * @returns {Error}
 */
export const setErrorMessage = (error?: string): Error<typeof SET_ANALYSES_ERROR> => ({
 ...
 */
export const setLoading = (loading: boolean): SetLoadingAction<typeof SET_ANALYSES_LOADING> => ({

...
case '/api/hpc/apps/group': return 'hpc.apps.deleteGroup';
case '/api/hpc/apps': return 'hpc.apps.delete';
case '/api/hpc/apps/group//clearLogo': return 'hpc.apps.clearGroupLogo';
...
case '/api/accounting/v2/searchSubAllocations': return 'accounting.v2.searchSubAllocations';
case '/api/accounting/v2/retrieveAllocationsInternal': return 'accounting.v2.retrieveAllocationsInternal';
...
case '/api/hpc/apps/group//set': return 'hpc.apps.setGroup';
case '/api/hpc/apps/group': return 'hpc.apps.createGroup';
case '/api/hpc/apps/group//update': return 'hpc.apps.updateGroup';
case '/api/hpc/apps/updateFlavor': return 'hpc.apps.updateFlavor';
case '/api/hpc/apps/createTag': return 'hpc.apps.createTag';
case '/api/hpc/apps/deleteTag': return 'hpc.apps.removeTag';
case '/api/hpc/apps/group//uploadLogo': return 'hpc.apps.uploadGroupLogo';
...
case '/api/accounting/v2/browseSubAllocations': return 'accounting.v2.browseSubAllocations';
...
case '/api/hpc/apps/store': return 'hpc.apps.store';
case '/api/hpc/apps/groups': return 'hpc.apps.listGroups';
case '/api/hpc/apps/group': return 'hpc.apps.retrieveGroup';
case '/api/hpc/apps/listTags': return 'hpc.apps.listTags';
case '/api/hpc/apps/group//logo': return 'hpc.apps.fetchLogo';
...
case '/api/hpc/apps/updateLanding': return 'hpc.apps.updateLanding';
case '/api/hpc/apps/updateOverview': return 'hpc.apps.updateOverview';

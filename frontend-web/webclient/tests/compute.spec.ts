...
TestContexts.map((ctx) => {
  test.describe(ctx, () => {
    ...
    test.describe("Compute - modules available, network connectivity", () => {
    ...
    test.describe("Compute - check starting jobs works", () => {
      test.describe("optional/mandatory parameters, logs", () => {
...
`;
        ...
        test.describe("Licenses - check license system works", () => {

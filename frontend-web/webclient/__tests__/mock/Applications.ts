    ...
    items: [
        {
            ...
            description: {
                ...
                parameters: [
                    ...
                    }, {name: "remove_lone", "optional": true, defaultValue: null, "title": "Remove lone", "description": "if true, removes lone fixes", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "filter_invalid", "optional": true, "defaultValue": null, "title": "Filter invalid", "description": "if true, removes invalid fixes", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "max_speed", "optional": true, "defaultValue": null, "title": "Max speed", "description": "Consider fix invalid if speed is greater than this value (in km/hr)", "min": null, "max": null, "step": null, "unitName": "km/hr", "type": ParameterTypes.Integer}, {"name": "max_ele_change", "optional": true, "defaultValue": null, "title": "Maximum elevation change", "description": "Consider fix invalid if elevation change is greater than this value (in meters)", "min": null, "max": null, "step": null, "unitName": "meters", "type": ParameterTypes.Integer}, {"name": "min_change_3_fixes", "optional": true, "defaultValue": null, "title": "min_change_3_fixes", "description": "Consider fix invalid if change in distance between fix 1 and 3 is less than this value (in meters). This helps remove GPS jitter.", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "detect_indoors", "optional": true, "defaultValue": null, "title": "Detect indoors", "description": "If true, mark position as indoors, outdoors or in-vehicle", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "max_sat_ratio", "optional": true, "defaultValue": null, "title": "max_sat_ratio", "description": "", "min": null, "max": null, "step": null, "unitName": null, "type": ParameterTypes.Integer}, {"name": "max_SNR_value", "optional": true, "defaultValue": null, "title": "max_SNR_value", "description": "", "min": null, "max": null, "step": null, "unitName": null, "type": ParameterTypes.Integer}, {"name": "min_distance", "optional": true, "defaultValue": null, "title": "Minimum distance", "description": "minimum distance (in meters) that must be travelled over one minute to indicate the start of a trip. Default chosen to be 34 meters which is equal to a typical walking speed of 2KM/hr.", "min": null, "max": null, "step": null, "unitName": "km/hr", "type": ParameterTypes.Integer}, {"name": "min_trip_length", "optional": true, "defaultValue": null, "title": "Minimum trip length", "description": "trips less than this distance (in meters) are not considered trips.", "min": null, "max": null, "step": null, "unitName": "meters", "type": ParameterTypes.Integer}, {"name": "min_trip_duration", "optional": true, "defaultValue": null, "title": "Minimum trip duration", "description": "trips less than this duration (in seconds) are not considered trips.", "min": null, "max": null, "step": null, "unitName": "seconds", "type": ParameterTypes.Integer}, {"name": "min_pause_duration", "optional": true, "defaultValue": null, "title": "Minimum pause duration", "description": "trips less than this duration (in seconds) are not considered trips.", "min": null, "max": null, "step": null, "unitName": "seconds", "type": ParameterTypes.Integer}, {"name": "max_pause_duration", "optional": true, "defaultValue": null, "title": "Maximum pause duration", "description": " when the duration of a pause exceeds this value, the point is marked as an end point.", "min": null, "max": null, "step": null, "unitName": null, "type": ParameterTypes.Integer}, {"name": "max_percent_single_location", "optional": true, "defaultValue": null, "title": "max_percent_single_location", "description": "maximum percentage of a trip's fixes that can occur at a single location.", "min": 0, "max": 100, "step": null, "unitName": "%", "type": ParameterTypes.Integer}, {"name": "max_percent_allowed_indoors", "optional": true, "defaultValue": null, "title": "max_percent_allowed_indoors", "description": "maximum percentage of a trip that is allowed indoors.", "min": 0, "max": 100, "step": null, "unitName": "%", "type": ParameterTypes.Integer}, {"name": "remove_indoor_fixes", "optional": true, "defaultValue": null, "title": "remove_indoor_fixes", "description": "if true, points at the start and end of a trip that are marked indoors are removed from the trip.", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "include_trip_pauses", "optional": true, "defaultValue": null, "title": "include_trip_pauses", "description": "if true, include trip pause points as locations.", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "trap_indoor_fixes", "optional": true, "defaultValue": null, "title": "trap_indoor_fixes", "description": "if true, stationary indoor fixes within a given radius of the location will be set to the center of the location.", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "trap_outdoor_fixes", "optional": true, "defaultValue": null, "title": "trap_outdoor_fixes", "description": "if true, stationary outdoor fixes will be set to the location center.", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "trap_trip_fixes", "optional": true, "defaultValue": null, "title": "trap_trip_fixes", "description": "if true, also include fixes that are part of trips.", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "allow_non_trips", "optional": true, "defaultValue": null, "title": "allow_non_trips", "description": "if true, locations may be included that are not part of a trip.", "trueValue": "true", "falseValue": "false", "type": ParameterTypes.Boolean}, {"name": "location_radius", "optional": true, "defaultValue": null, "title": "location_radius", "description": "defines radius (in meters) of location in which fixes are trapped.", "min": null, "max": null, "step": null, "unitName": "meters", "type": ParameterTypes.Integer}, {"name": "min_duration_at_location", "optional": true, "defaultValue": null, "title": "min_duration_at_location", "description": "minimum amount of time (in seconds) that must be spent at a location for it to be considered a location.", "min": null, "max": null, "step": null, "unitName": "seconds", "type": ParameterTypes.Integer}, {"name": "vehicle_cutoff", "optional": true, "defaultValue": null, "title": "vehicle_cutoff", "description": "speeds greater than this value (in KM/hr) will be marked as vehicle.", "min": null, "max": null, "step": null, "unitName": "km/hr", "type": ParameterTypes.Integer}, {"name": "bicycle_cutoff", "optional": true, "defaultValue": null, "title": "bicycle_cutoff", "description": "speeds greater than this value (in KM/hr) will be marked as bicycle.", "min": null, "max": null, "step": null, "unitName": "km/hr", "type": ParameterTypes.Integer}, {"name": "walk_cutoff", "optional": true, "defaultValue": null, "title": "walk_cutoff", "description": "speeds greater than this value (in KM/hr) will be marked as pedestrian.", "min": null, "max": null, "step": null, "unitName": "km/hr", "type": ParameterTypes.Integer}, {"name": "percentile_to_sample", "optional": true, "defaultValue": null, "title": "percentile_to_sample", "description": "speed comparisons are made at this percentile.", "min": null, "max": null, "step": null, "unitName": null, "type": ParameterTypes.Integer}, {"name": "min_segment_length", "optional": true, "defaultValue": null, "title": "min_segment_length", "description": "minimum length (in meters) of segments used to classify mode of transportation.", "min": null, "max": null, "step": null, "unitName": "meters", "type": ParameterTypes.Integer}],
            ...
            owner: "jonas@hinchely.dk", createdAt: 1531308013745, modifiedAt: 1531308013745, description: {
                ...
                authors: ["Dan Sebastian Thrane <dthrane@imada.sdu.dk>"],
                title: "BWA-MEM", description: "BWA-MEM", invocation: [{type: "word", word: "bwa-mem"}, {type: "var", variableNames: ["index_base_main"], prefixGlobal: "", "suffixGlobal": "", "prefixVariable": "", "suffixVariable": "", "variableSeparator": " "}, {"type": "var", "variableNames": ["R1"], "prefixGlobal": "", "suffixGlobal": "", "prefixVariable": "", "suffixVariable": "", "variableSeparator": " "}, {"type": "var", "variableNames": ["R2"], "prefixGlobal": "", "suffixGlobal": "", "prefixVariable": "", "suffixVariable": "", "variableSeparator": " "}], "parameters": [{"name": "index_base_main", "optional": false, "defaultValue": null, "title": "Index Resources", "description": "", "type": ParameterTypes.InputFile}, {"name": "base_dict", "optional": false, "defaultValue": null, "title": ".fasta.dict", "description": "", "type": ParameterTypes.InputFile}, {"name": "base_amb", "optional": false, "defaultValue": null, "title": ".fasta.amb", "description": "", "type": ParameterTypes.InputFile}, {"name": "base_ann", "optional": false, "defaultValue": null, "title": ".fasta.ann", "description": "", "type": ParameterTypes.InputFile}, {"name": "base_bwt", "optional": false, "defaultValue": null, "title": ".fasta.bwt", "description": "", "type": ParameterTypes.InputFile}, {"name": "base_fai", "optional": false, "defaultValue": null, "title": ".fasta.fai", "description": "", "type": ParameterTypes.InputFile}, {"name": "base_pac", "optional": false, "defaultValue": null, "title": ".fasta.pac", "description": "", "type": ParameterTypes.InputFile}, {"name": "base_sa", "optional": false, "defaultValue": null, "title": ".fasta.sa", "description": "", "type": ParameterTypes.InputFile}, {"name": "R1", "optional": false, "defaultValue": null, "title": "R1", "description": "", "type": ParameterTypes.InputFile}, {"name": "R2", "optional": false, "defaultValue": null, "title": "R2", "description": "", "type": ParameterTypes.InputFile}], "outputFileGlobs": ["sample.bam*", "stdout.txt", "stderr.txt"]
            }, tool: {owner: "jonas@hinchely.dk", createdAt: 1531304635371, modifiedAt: 1531304635371, description: {license: "FauxPL", info: {name: "bwa-sambamba", version: "3.3.0"}, container: "bwa-sambamba", defaultNumberOfNodes: 1, defaultTasksPerNode: 1, defaultAllocationTime: {hours: 1, minutes: 0, seconds: 0}, requiredModules: [], authors: ["Dan Sebastian Thrane <dthrane@imada.sdu.dk>"], title: "bwa-sambamba", description: "Tools for running bwa-sambamba", backend: "UDOCKER"}}
        }, {
            imageUrl: "",
            favorite: false,
            owner: "jonas@hinchely.dk", createdAt: 1531305600165, modifiedAt: 1531305600165, description: {
                ...
                parameters: [{name: "n", optional: false, defaultValue: {value: 100, type: "int"}, title: "Count", description: "How much should we count to?", min: null, "max": null, "step": null, "unitName": null, "type": ParameterTypes.Integer}], "outputFileGlobs": ["stdout.txt", "stderr.txt"]
            },
            tool: {
                owner: "jonas@hinchely.dk",
            ...
            }, tool: {owner: "jonas@hinchely.dk", createdAt: 1531304469178, modifiedAt: 1531304469178, description: {license: "FauxPL", info: {"name": "tqdist", "version": "1.0.0"}, "container": "tqdist.simg", defaultNumberOfNodes: 1, defaultTasksPerNode: 1, defaultAllocationTime: {hours: 0, minutes: 10, seconds: 0}, requiredModules: [], authors: ["Dan Sebastian Thrane <dthrane@imada.sdu.dk>"], "title": "tqDist", "description": "Tools for running tqDist", "backend": "SINGULARITY"}}
        }, {
            favorite: false,
            imageUrl: "",
            owner: "jonas@hinchely.dk",
            ...
            description: {
                ...
                parameters: [
                    {
                        name: "text",
                        optional: false, defaultValue: null, title: "Some text to render with figlet", description: "", type: ParameterTypes.Text
                    }],
                outputFileGlobs: ["stdout.txt", "stderr.txt"]
            },
            tool: {
            ...
            owner: "jonas@hinchely.dk", createdAt: 1531307717715, modifiedAt: 1531307717715, description: {
                ...
                parameters: [{name: "file", optional: false, defaultValue: null, title: "Input File", description: "", type: ParameterTypes.InputFile}, {name: "format", optional: true, defaultValue: null, title: "Input Format", description: "The program can usually guess the input format, otherwise this option can be used to choose between different formats. To infer a tree from an alignment in Stockholm format use 'sth'.", "type": ParameterTypes.Text}], "outputFileGlobs": ["stdout.txt", "stderr.txt"]
            }, tool: {owner: "jonas@hinchely.dk", createdAt: 1531304528792, modifiedAt: 1531304528792, description: {license: "FauxPL", info: {name: "rapidnj", version: "2.3.2"}, container: "rapidnj.simg", defaultNumberOfNodes: 1, defaultTasksPerNode: 1, defaultAllocationTime: {hours: 0, minutes: 10, seconds: 0}, requiredModules: [], authors: ["Dan Sebastian Thrane <dthrane@imada.sdu.dk>"], title: "RapidNJ", description: "Tools for running rapidnj", "backend": "SINGULARITY"}}
        }, {
            favorite: false,
            imageUrl: "",
            owner: "jonas@hinchely.dk",
            ...
            owner: "jonas@hinchely.dk", createdAt: 1531307353519, modifiedAt: 1531307353519, description: {
                ...
                description: {
                    ...
                    container: "tqdist.simg", defaultNumberOfNodes: 1, defaultTasksPerNode: 1, defaultAllocationTime: {hours: 0, minutes: 10, seconds: 0}, requiredModules: [], authors: ["Dan Sebastian Thrane <dthrane@imada.sdu.dk>"], title: "tqDist", description: "Tools for running tqDist", backend: "SINGULARITY"
                }
            }
        }],
    pagesInTotal: 0

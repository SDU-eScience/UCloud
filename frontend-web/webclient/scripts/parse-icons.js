...
const src = path.join(__dirname, '..', 'app/ui-components/icons')
const filepath = path.join(__dirname, '..', 'app/ui-components/icons.json')

const writeFile = data => {
  const json = JSON.stringify({ icons: data })

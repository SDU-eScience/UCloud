...
val verifiedJob = verifiedJobForTestGenerator(currentState = JobState.IN_QUEUE)

val verifiedJob2 = verifiedJobForTestGenerator(id = "verifiedId2", currentState = JobState.IN_QUEUE)

...
class DockerImageSizeQuery {
    ...
    private suspend fun fetchToken(realm: String, params: Map<String, String>): String {
        ...
        return defaultMapper.readValue<TokenResponse>(text).access_token
    }
    ...
    suspend fun estimateSize(qualifiedImage: String): Long {
        ...
        val manifest = defaultMapper.readValue<DockerManifest>(
            queryRegistry(tok, "https://$registry/v2/$image/manifests/$tag").content.toByteArray(1024 * 1024 * 8)
        )

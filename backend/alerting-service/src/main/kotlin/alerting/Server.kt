    ...
    override fun start() {
        ...
        GlobalScope.launch {
            try {
                ...
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on nodes caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
                exitProcess(1)
            }
        ...
        GlobalScope.launch {
            try {
                ...
                log.warn(ex.stackTraceToString())
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on shard docs  caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
                exitProcess(1)
            }
        ...
        GlobalScope.launch {
            try {
                ...
                log.warn(ex.stackTraceToString())
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on cluster health caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
                exitProcess(1)
            }
        ...
        GlobalScope.launch {
            try {
                ...
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on 500 status' caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
                exitProcess(1)
            }
        ...
        GlobalScope.launch {
            try {
                ...
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on cluster storage caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
        ...
        GlobalScope.launch {
            try {
                ...
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on crash loop caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
                exitProcess(1)
            }
        ...
        GlobalScope.launch {
            try {
                ...
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on elastic indices caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
                exitProcess(1)
            }
        ...
        GlobalScope.launch {
            try {
                ...
                SlackDescriptions.sendMessage.call(
                    SendMessageRequest("WARNING: Alert on many 4xx and 5xx through ambassador caught exception: ${ex.stackTraceToString()}."),
                    authenticatedClient
                )
                exitProcess(1)
            }

...
update file_orchestrator.metadata_templates
set
    schema = '{"type": "object", "title": "UCloud: Favorite Files", "required": ["favorite"], "properties": {"favorite": {"type": "boolean", "title": "Is this file one of your favorites?"}}, "description": "A document describing your favorite files", "dependencies": {}}'::jsonb,
    inheritable = false

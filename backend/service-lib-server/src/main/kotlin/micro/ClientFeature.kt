...
class ClientFeature : ClientFeatureBase {
    private lateinit var ctx: Micro
    override val client: RpcClient = RpcClient()
    ...
    companion object Feature : MicroFeatureFactory<ClientFeature, Unit>, Loggable {
        ...
        override val key: MicroAttributeKey<ClientFeature> = MicroAttributeKey("client-feature")

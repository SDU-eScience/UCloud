...
private val log = LoggerFactory.getLogger("dk.sdu.cloud.person.MainKt")
...
class Configuration(
    ...
    internal fun configure() {
        connection.configure(PersonServiceDescription, 42500)
    }
}
...
fun main(args: Array<String>) {
    val configuration = run {
        ...
        val configFilePath = args.getOrNull(0) ?: "/etc/${PersonServiceDescription.name}/config.json"

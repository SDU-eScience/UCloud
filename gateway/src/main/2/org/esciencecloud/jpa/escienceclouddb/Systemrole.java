...
@NamedQueries({
        ...
        , @NamedQuery(name = "Systemrole.findBySystemroleactive", query = "SELECT s FROM Systemrole s WHERE s.systemroleactive = :systemroleactive")})
public class Systemrole implements Serializable {
    ...
    @Column(name = "systemroleactive")
    private Integer systemroleactive;
    ...
    public Integer getSystemroleactive() {
        return systemroleactive;
    }

    public void setSystemroleactive(Integer systemroleactive) {
        this.systemroleactive = systemroleactive;
    }

...
@NamedQueries({
        ...
        , @NamedQuery(name = "Projectrole.findByProjectroleactive", query = "SELECT p FROM Projectrole p WHERE p.projectroleactive = :projectroleactive")
...
public class Projectrole implements Serializable {
    ...
    @Column(name = "projectroleactive")
    private Integer projectroleactive;
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "projectrolerefid")
    private List<Uimenutype> uimenutypeList;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "projectrolerefid")
    ...
    public Integer getProjectroleactive() {
        return projectroleactive;
    }

    public void setProjectroleactive(Integer projectroleactive) {
        this.projectroleactive = projectroleactive;
    }
    ...
    @XmlTransient
    public List<Uimenutype> getUimenutypeList() {
        return uimenutypeList;
    }

    public void setUimenutypeList(List<Uimenutype> uimenutypeList) {
        this.uimenutypeList = uimenutypeList;
    }

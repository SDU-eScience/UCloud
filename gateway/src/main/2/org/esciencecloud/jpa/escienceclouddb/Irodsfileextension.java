...
@NamedQueries({
        ...
        , @NamedQuery(name = "Irodsfileextension.findByIrodsfileextensionactive", query = "SELECT i FROM Irodsfileextension i WHERE i.irodsfileextensionactive = :irodsfileextensionactive")
...
public class Irodsfileextension implements Serializable {
    ...
    @Column(name = "irodsfileextensionactive")
    private Integer irodsfileextensionactive;
    ...
    public Integer getIrodsfileextensionactive() {
        return irodsfileextensionactive;
    }

    public void setIrodsfileextensionactive(Integer irodsfileextensionactive) {
        this.irodsfileextensionactive = irodsfileextensionactive;
    }

...
@NamedQueries({
        ...
        , @NamedQuery(name = "Logintype.findByLogintypeactive", query = "SELECT l FROM Logintype l WHERE l.logintypeactive = :logintypeactive")})
public class Logintype implements Serializable {
    ...
    @Column(name = "logintypeactive")
    private Integer logintypeactive;
    ...
    public Integer getLogintypeactive() {
        return logintypeactive;
    }

    public void setLogintypeactive(Integer logintypeactive) {
        this.logintypeactive = logintypeactive;
    }

...
@NamedQueries({
        ...
        , @NamedQuery(name = "Personappusermessagesubscriptiontyperel.findByPersonappusermessagesubscriptiontyperelactive", query = "SELECT p FROM Personappusermessagesubscriptiontyperel p WHERE p.personappusermessagesubscriptiontyperelactive = :personappusermessagesubscriptiontyperelactive")
...
public class Personappusermessagesubscriptiontyperel implements Serializable {
    ...
    @Column(name = "id")
    private Integer id;
    @Column(name = "personappusermessagesubscriptiontyperelactive")
    private Integer personappusermessagesubscriptiontyperelactive;
    @Basic(optional = false)
    ...
    public Integer getPersonappusermessagesubscriptiontyperelactive() {
        return personappusermessagesubscriptiontyperelactive;
    }

    public void setPersonappusermessagesubscriptiontyperelactive(Integer personappusermessagesubscriptiontyperelactive) {
        this.personappusermessagesubscriptiontyperelactive = personappusermessagesubscriptiontyperelactive;
    }

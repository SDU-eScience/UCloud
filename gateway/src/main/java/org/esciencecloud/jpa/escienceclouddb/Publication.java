...
@NamedQueries({
        ...
        , @NamedQuery(name = "Publication.findByPublicationactive", query = "SELECT p FROM Publication p WHERE p.publicationactive = :publicationactive")})
public class Publication implements Serializable {
    ...
    @Column(name = "publicationactive")
    private Integer publicationactive;
    ...
    public Integer getPublicationactive() {
        return publicationactive;
    }

    public void setPublicationactive(Integer publicationactive) {

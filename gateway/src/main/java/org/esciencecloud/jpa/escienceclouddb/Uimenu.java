...
public class Uimenu implements Serializable {
    ...
    private Collection<Uimenudetail> uimenudetailCollection;
    ...
    @XmlTransient
    public Collection<Uimenudetail> getUimenudetailCollection() {
        return uimenudetailCollection;
    }

    public void setUimenudetailCollection(Collection<Uimenudetail> uimenudetailCollection) {
        this.uimenudetailCollection = uimenudetailCollection;
    }

...
@NamedQueries({
        ...
        , @NamedQuery(name = "Irodsaccesstype.findByIrodsaccesstypeactive", query = "SELECT i FROM Irodsaccesstype i WHERE i.irodsaccesstypeactive = :irodsaccesstypeactive")
...
public class Irodsaccesstype implements Serializable {
    ...
    @Column(name = "irodsaccesstypeactive")
    private Integer irodsaccesstypeactive;
    @Basic(optional = false)
    ...
    public Integer getIrodsaccesstypeactive() {
        return irodsaccesstypeactive;
    }

    public void setIrodsaccesstypeactive(Integer irodsaccesstypeactive) {
        this.irodsaccesstypeactive = irodsaccesstypeactive;
    }

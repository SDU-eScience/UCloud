...
@NamedQueries({
        ...
        , @NamedQuery(name = "Irodsruleexectype.findByIrodsruleexectypeactive", query = "SELECT i FROM Irodsruleexectype i WHERE i.irodsruleexectypeactive = :irodsruleexectypeactive")
...
public class Irodsruleexectype implements Serializable {
    ...
    @Column(name = "irodsruleexectypeactive")
    private Integer irodsruleexectypeactive;
    @Basic(optional = false)
    ...
    public Integer getIrodsruleexectypeactive() {
        return irodsruleexectypeactive;
    }

    public void setIrodsruleexectypeactive(Integer irodsruleexectypeactive) {
        this.irodsruleexectypeactive = irodsruleexectypeactive;
    }

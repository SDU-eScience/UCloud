...
public class ProjectFacade {
    ...
    public String listAllActiveProject() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Project> entityList = new ArrayList<>();
        Query nq1 = em.createNamedQuery("Project.findByActive");
    ...
    public String entityToJson(Project entity) {
        String json = null;
    ...
    public String entityListToJson(List<Project> entityList) {
        String json = null;
        ObjectMapper mapper = new ObjectMapper();
        try {

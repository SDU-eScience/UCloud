...
public class ProjectprojectresearchtyperelFacade {
    ...
    public boolean deleteProjectprojectresearchtyperelById(int id) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        em.remove(em.find(Projectprojectresearchtyperel.class, id));
        em.getTransaction().commit();
        em.close();
        emf.close();
        return true;
    ...
    public String listAllActiveProjectprojectresearchtyperel() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Projectprojectresearchtyperel> entityList = new ArrayList<>();
        Query nq1 = em.createNamedQuery("Projectprojectresearchtyperel.findByActive");
    ...
    public String listAllProjectprojectresearchtyperel() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Projectprojectresearchtyperel> entityList = new ArrayList<>();
    ...
    public String entityToJson(Projectprojectresearchtyperel entity) {
        String json = null;
    ...
    public String entityListToJson(List<Projectprojectresearchtyperel> entityList) {
        String json = null;
        ObjectMapper mapper = new ObjectMapper();
        try {

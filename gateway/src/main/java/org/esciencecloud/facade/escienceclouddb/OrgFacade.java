...
public class OrgFacade {
    ...
    public String listAllActiveOrg() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Org> entityList = new ArrayList<>();
        Query nq1 = em.createNamedQuery("Org.findByActive");
    ...
    public String entityToJson(Org entity) {
        String json = null;
    ...
    public String entityListToJson(List<Org> entityList) {
        String json = null;
        ObjectMapper mapper = new ObjectMapper();
        try {

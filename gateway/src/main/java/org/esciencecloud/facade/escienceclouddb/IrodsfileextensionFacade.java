...
public class IrodsfileextensionFacade {
    ...
    public boolean deleteIrodsfileextensionById(int id) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        em.remove(em.find(Irodsfileextension.class, id));
        em.getTransaction().commit();
        em.close();
        emf.close();
        return true;
    ...
    public String listAllActiveIrodsfileextension() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Irodsfileextension> entityList = new ArrayList<>();
        Query nq1 = em.createNamedQuery("Irodsfileextension.findByActive");
    ...
    public String listAllIrodsfileextension() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Irodsfileextension> entityList = new ArrayList<>();
    ...
    public String entityToJson(Irodsfileextension entity) {
        String json = null;
    ...
    public String entityListToJson(List<Irodsfileextension> entityList) {
        String json = null;
        ObjectMapper mapper = new ObjectMapper();
        try {

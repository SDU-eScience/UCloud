...
public class ProjectorgrelFacade {
    ...
    public boolean deleteProjectorgrelById(int id) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        em.remove(em.find(Projectorgrel.class, id));
        em.getTransaction().commit();
        em.close();
        emf.close();
        return true;
    ...
    public String listAllActiveProjectorgrel() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Projectorgrel> entityList = new ArrayList<>();
        Query nq1 = em.createNamedQuery("Projectorgrel.findByActive");
    ...
    public String listAllProjectorgrel() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Projectorgrel> entityList = new ArrayList<>();
    ...
    public String entityToJson(Projectorgrel entity) {
        String json = null;
    ...
    public String entityListToJson(List<Projectorgrel> entityList) {
        String json = null;
        ObjectMapper mapper = new ObjectMapper();
        try {

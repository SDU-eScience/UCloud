...
public class PersonFacade {
    ...
    public String listAllActivePerson() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Person> entityList = new ArrayList<>();
        Query nq1 = em.createNamedQuery("Person.findByActive");
    ...
    public String entityToJson(Person entity) {
        String json = null;
    ...
    public String entityListToJson(List<Person> entityList) {
        String json = null;
        ObjectMapper mapper = new ObjectMapper();
        try {

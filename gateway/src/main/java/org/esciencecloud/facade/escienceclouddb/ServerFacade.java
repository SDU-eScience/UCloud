...
public class ServerFacade {
    ...
    public boolean deleteServerById(int id) {
        ...
        EntityManager em = emf.createEntityManager();
        em.getTransaction().begin();
        em.remove(em.find(Server.class, id));
        em.getTransaction().commit();
        em.close();
        emf.close();
        return true;
    ...
    public String listAllActiveServer() {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("eScienceCloudJPAPU");
        EntityManager em = emf.createEntityManager();
        List<Server> entityList = new ArrayList<>();
        Query nq1 = em.createNamedQuery("Server.findByActive");
    ...
    public String entityToJson(Server entity) {
        String json = null;
    ...
    public String entityListToJson(List<Server> entityList) {
        String json = null;
        ObjectMapper mapper = new ObjectMapper();
        try {

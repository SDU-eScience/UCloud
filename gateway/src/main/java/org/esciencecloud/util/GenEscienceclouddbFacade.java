...
public class GenEscienceclouddbFacade {
    ...
    public static List<String> getTableNames() {
        ...
        listTablenNames.add("app");
        listTablenNames.add("appappsourcelanguagerel");
        listTablenNames.add("appsourcelanguage");
    ...
    public static void createFacade(String packetName, String className, String filePathString, String jpaClass) {
        ...
        lines.add("");
        lines.add("");
        lines.add("public boolean delete" + jpaClass + "ById(int id){");
        lines.add("EntityManagerFactory emf = Persistence.createEntityManagerFactory(\"eScienceCloudJPAPU\");");
        lines.add("EntityManager em = emf.createEntityManager();");
        lines.add("");
        lines.add("em.getTransaction().begin();");
        ...
        lines.add("");
        lines.add("");
        lines.add("public String listAllActive" + jpaClass + " (){");
        lines.add("EntityManagerFactory emf = Persistence.createEntityManagerFactory(\"eScienceCloudJPAPU\");");
        lines.add("EntityManager em = emf.createEntityManager();");
        lines.add("");
        lines.add("List<" + jpaClass + "> entityList = new ArrayList<>();");
        lines.add("Query nq1 = em.createNamedQuery(\"" + jpaClass + ".findByActive\");");
        lines.add("nq1.setParameter(\"active\",1);");
        lines.add("entityList.addAll(nq1.getResultList());");
        lines.add("em.close();");
        lines.add("emf.close();");
        lines.add("return entityListToJson(entityList);}");
        lines.add("");
        lines.add("");
        lines.add("public String listAll" + jpaClass + " (){");
        lines.add("EntityManagerFactory emf = Persistence.createEntityManagerFactory(\"eScienceCloudJPAPU\");");
        lines.add("EntityManager em = emf.createEntityManager();");
        lines.add("");
        lines.add("List<" + jpaClass + "> entityList = new ArrayList<>();");
        ...
        lines.add("");
        lines.add("");
        lines.add("public String entityToJson(" + jpaClass + " entity)");
        lines.add("{");
        lines.add("String json = null;");
        lines.add("ObjectMapper mapper = new ObjectMapper();");
        lines.add("try {");
        lines.add("json = mapper.writeValueAsString(entity);");
        lines.add("} catch (java.io.IOException e) {");
        ...
        lines.add("");
        lines.add("");
        lines.add("public String entityListToJson(List<" + jpaClass + "> entityList)");
        lines.add("{");
        lines.add("String json = null;");
        lines.add("ObjectMapper mapper = new ObjectMapper();");
        lines.add("try {");
        lines.add("json = mapper.writeValueAsString(entityList);");
        lines.add("} catch (java.io.IOException e) {");
        lines.add("e.printStackTrace();");
        lines.add("}");
        lines.add("return json;");

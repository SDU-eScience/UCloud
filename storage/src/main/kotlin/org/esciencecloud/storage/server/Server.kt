...
fun retrieveConnectionFactory(): StorageConnectionFactory = TODO()

fun createPersistentAdminConnection(factoryStorage: StorageConnectionFactory) = factoryStorage.createForAccount("rods", "rods")
 ...
 */
fun validateRequest(request: StorageRequest): Result<StorageConnection> = Ok(TODO())
...
suspend fun PipelineContext<Unit>.parseStorageRequestAndValidate(): Pair<StorageRequest, StorageConnection>? {

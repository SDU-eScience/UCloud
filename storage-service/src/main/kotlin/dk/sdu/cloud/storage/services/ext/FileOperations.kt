...
interface FileOperations {
     ...
     * created as well.
     *
     * @throws StorageException.NotFound If the directory could not be created. This will happen if [recursive] flag
     ...
     *
     * @throws StorageException.BadPermissions If a file cannot be created at the given [path]
     * @throws StorageException.NotFound If object at [path] is not a directory or does not exist
     */
     ...
     *
     * @throws StorageException.NotFound If [recursive] is not set and the directory is not empty
     * @throws StorageException.BadPermissions If the object was found but the user lacks sufficient permissions to perform this
     * action
     * @throws StorageException.NotFound If the object could not be found by the user
     */
...
interface AccessControlOperations {
     ...
     *
     * @throws StorageException.NotFound if the object is not found
     */
     ...
     *
     * @throws StorageException.NotFound if the object is not found or the connected user does not have permission to know
     * about the object
     */
...
interface FileQueryOperations {
     ...
     *
     * @throws StorageException.NotFound If the object could not be found
     */
    fun stat(path: StoragePath): StorageFile {
     ...
     */
    fun statBulk(vararg paths: StoragePath): List<StorageFile?>

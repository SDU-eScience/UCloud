...
import dk.sdu.cloud.storage.api.UserType
...
interface UserAdminOperations {
     ...
     * user already exists)
     */
    fun createUser(username: String, password: String? = null, type: UserType = UserType.USER): Unit
     ...
     */
    fun modifyPassword(username: String, newPassword: String): Unit

    ...
    fun configure(routing: Route) = with(routing) {
        route("files") {
            implement(FileDescriptions.download) {
                ...
                val path = connection.paths.parseAbsolute(it.path, true)
                // TODO FIXME
                ...
                call.respondDirectWrite(stat.sizeInBytes) {
                    ...
                    val stream = try {
                        ...
                        // Hopefully this won't happen. Because it is way too late to change anything in the response

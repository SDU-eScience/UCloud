...
interface FilePlugin : ResourcePlugin<Product.Storage, FSSupport, UFile, ConfigSchema.Plugins.Files> {
    ...
    suspend fun RequestContext.handleFolderUploadWs(session: String, pluginData: String, fileCollections: SimpleCache<String, FileCollection>, websocket: WebSocketSession, lastChunk: Boolean)
...
abstract class EmptyFilePlugin : FilePlugin {
    ...
    override suspend fun RequestContext.handleFolderUploadWs(session: String, pluginData: String, collection: SimpleCache<String, FileCollection>, websocket: WebSocketSession, lastChunk: Boolean) = throw RPCException("Not supported", HttpStatusCode.BadRequest)

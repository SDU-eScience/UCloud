...
type FilesetResponseItem struct {
	Config struct {
...
type FilesetResponse struct {
	Filesets []FilesetResponseItem `json:"filesets"`
...
type QuotaResponse struct {
	Quotas []QuotaResponseItem `json:"quotas"`
	Status StatusReponse       `json:"status"`
}

type JobResponseItem struct {
...
type JobResponse struct {
	Jobs   []JobResponseItem `json:"jobs"`
	Status StatusReponse     `json:"status"`
}

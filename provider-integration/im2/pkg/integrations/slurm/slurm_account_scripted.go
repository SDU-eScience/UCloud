...
type scriptedAccountManagementService struct {
	onQuotaUpdated   controller.Script[scriptedSlurmAccQuotaUpdated, util.Empty]
	onUsageReporting controller.Script[util.Empty, struct {
...
func (u *scriptedAccountManagementService) synchronizeProjectToSlurmAccount(project *fnd.Project, comparison *controller.ProjectComparison) {

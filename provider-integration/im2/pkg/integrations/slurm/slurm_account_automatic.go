...
func (a *automaticAccountManagementService) synchronizeProjectToSlurmAccount(project *fnd.Project, comparison *controller.ProjectComparison) {
...
func (a *automaticAccountManagementService) FetchUsageInMinutes() map[SlurmAccountOwner]int64 {
	...
	allocations := map[string][]controller.TrackedAllocation{}

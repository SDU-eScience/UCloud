...
type PasswordClaimResetTokenRequest struct {
	Token       string
	NewPassword string
}
...
// PasswordClaimResetToken Reset the password of a user based on a genereated password-reset token
var PasswordClaimResetToken = rpc.Call[PasswordClaimResetTokenRequest, util.Empty]{
	BaseContext: PasswordResetContext,
	Convention:  rpc.ConventionUpdate,
	Operation:   "new",
	Roles:       rpc.RolesPublic,
